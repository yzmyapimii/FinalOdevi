...
{
    //nesne olusturmak icin gerekli bilgileri alan ve islemleri yapan sınıf.
    //nesne sınıfı icinde tanımlanan metod ile kullanıcıdan aldığımız verileri gerekli değişkenlere atadık.
    public class Nesne
    {
        private string ad;
        private int miktar;
